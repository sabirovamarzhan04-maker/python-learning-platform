...
def generate_tasks(req: TaskRequest):
    ...
    context_msg += (
        ...
        "9-10 код форматы:\n"
        "{ \"type\":\"code\", \"question\":\"Кодтағы қатені табыңыз немесе бос орынды толықтырыңыз\", "
        "\"template\":\"кемінде 6-10 жол Python коды, ішінде ______ немесе қате жол болсын\", "
        "\"answer\":[\"дұрыс жауап\"], "
        "\"explanation\":\"Код неге осылай түзетіледі, қысқаша түсіндір\" }\n\n"
