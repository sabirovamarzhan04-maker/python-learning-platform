...
def generate_tasks(req: TaskRequest):
    ...
    context_msg += (
        ...
        "- Тапсырмаларда тек бір қысқа жол емес, толық әрі құрылымды Python коды берілсін.\n"
        "- Код beginner деңгейіндегі оқушыға түсінікті, оқуға ыңғайлы және логикалық түрде жазылсын.\n"
        "- Мысалдарда for, while, if, elif, else, print, list, function сияқты нақты Python тақырыптары қолданылсын.\n"
        "- Кейбір тапсырмаларда бос орын __ түрінде беріліп, оқушы missing code толықтырсын.\n"
        "- Кейбір тапсырмаларда кодтағы қатені табу ұсынылсын.\n"
        "- Кейбір тапсырмаларда output бойынша missing code немесе missing condition анықталсын.\n"
        "- Әр code тапсырмасында міндетті түрде expected_output көрсетілсін.\n"
        "- Кодтар visually IDE немесе screenshot стиліне ұқсас code block форматында берілсін.\n"

        "Қатаң ережелер:\n"
        "- 1–5 тапсырмалар тек тест форматында болсын.\n"
        "- 6–8 тапсырмалар тек теориялық сұрақтар болсын және жауап нұсқалары берілмесін.\n"
        "- 9–10 тапсырмалар тек code форматында болсын.\n"
        "- Code тапсырмаларындағы код бірнеше жолдан тұратын, толық әрі шынайы мысал сияқты көрінсін.\n"
        "- Барлық тапсырмалар тек берілген Python тақырыбына қатысты болсын.\n"
        "- Барлық мәтін толық қазақ тілінде жазылсын.\n"

        "Сұрақтарға қойылатын талаптар:\n"
        "- Сұрақтар сапалы, логикалық және адам құрастырғандай табиғи болсын.\n"
        "- Өте оңай, мағынасыз немесе бір сөзбен жауап берілетін сұрақтар болмауы керек.\n"
        "- Python синтаксисіне сәйкес нақты әрі практикалық сұрақтар берілсін.\n"
        "- Beginner деңгейіндегі оқушыға пайдалы әрі ойландыратын тапсырмалар құрылсын.\n"
        "- Сұрақтар тек теория емес, кодты түсіну және талдау дағдыларын дамытуға бағытталсын.\n"

        "Тест сұрақтарына мысалдар:\n"
        "- Код экранға не шығарады?\n"
        "- Қай жолда синтаксистік қате бар?\n"
        "- Қай оператор белгілі бір шартты тексереді?\n"
        "- Цикл неше рет орындалады?\n"
        "- Айнымалы соңында қандай мән сақтайды?\n"
        "- print() функциясының нәтижесі қандай болады?\n"

        "Мынадай сапасыз сұрақтар БОЛМАСЫН:\n"
        "- ‘#’ нені білдіреді?\n"
        "- Python жақсы программалау тілі ме?\n"
        "- while циклі бар ма?\n"
        "- Өте қысқа немесе мағынасыз жауапты талап ететін сұрақтар.\n"

        "Жауап нұсқаларына қойылатын талаптар:\n"
        "- Жауаптар бір-біріне ұқсас әрі ойландыратын болсын.\n"
        "- ‘Түсінбеймін’, ‘Білмеймін’, ‘Қате’ сияқты мағынасыз жауаптар қолданылмасын.\n"
        "- Барлық жауап нұсқалары Python логикасына сәйкес шынайы көрінсін.\n"

        "Барлық сұрақтар нақты лекция тақырыбына сәйкес құрылсын.\n"
        "Сұрақтар оқушының кодты түсіну, талдау және логикалық ойлау қабілетін дамытуға бағытталсын.\n"
    )
